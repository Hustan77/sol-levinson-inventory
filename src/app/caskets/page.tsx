...
import {
  ArrowLeft, Plus, Search, Edit, Trash2, RotateCcw, Settings, Clock,
  AlertTriangle, Package, Flame, Calendar, Users, ShoppingCart
} from 'lucide-react'
                ...
                {orders.slice(0, 12).map((order) => (
                  ...
                  >
                    <div className="flex justify-between items-start">
                      ...
                      {['casket', 'urn'].includes(order.type) && (
                        <button
                          onClick={() => {
                            setSelectedOrder(order)
                            setShowArrivalModal(true)
                          }}
                          className="mt-2 text-xs text-white bg-emerald-600 hover:bg-emerald-700 px-3 py-1 rounded"
                        >
                          Mark Arrived
                        </button>
                      )}
